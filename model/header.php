...
<header>
    ...
    <div class="container">
        <!-- Logo -->
        <div class="title">
            <a href="index.php" title="MyLiShop"> <img src="images/logo_myshop.png" width="260px;" height="180px;"> </a>
        </div>
        <!-- /logo -->
        <div class="col-sm-12 col-md-12 account">
            <div class="row">
                <?php
                    ...
                    {
                ?>
                <a href="../user/profile.php" style="text-decoration:none; color:black;">
                    ...
                    <ul class="nav navbar-nav">
                     ...
                     <!-- PRICE FILTER -->
                        <div style="margin-left:10px;">
                            <form action="filter-product.php" method="GET" style="display:flex; gap:5px;">
