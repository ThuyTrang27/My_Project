                ...
                <div class="panel panel-danger register">
                            ...
                            <div class="row">
                                <div class="btSubmit">
                                    <div class="col-xs-12 col-md-6 col-md-offset-3">
                                        <input type="submit" class="btn btn-info btn-block btn-lg" name="submit1" value="Đăng ký">
                                    </div><!-- /col -->
                                </div><!-- /btnSubmit -->
                            </div><!-- /row -->
                        </div><!-- /panel-body -->
                    ...
                    <form action="email-form.php" method="POST">
                        <div class="row">
                                <div class="btSubmit">
                                    <div class="col-xs-12 col-md-6 col-md-offset-3">
                                        <input type="submit" class="btn btn-info btn-block btn-lg" name="submit2" value="Đăng ký với email">
                                    </div><!-- /col -->
                                </div><!-- /btnSubmit -->
                            </div><!
                    </form>
